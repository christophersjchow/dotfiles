...
puts "#{Tty.blue}#{home}/Coding/dotfiles/oh-my-zsh/...#{Tty.reset}"
...
puts "#{Tty.magenta}#{home}/.oh-my-zsh#{Tty.reset}#{Tty.reset} -> #{home}/Coding/dotfiles/oh-my-zsh"
...
puts "#{Tty.magenta}#{home}/.lscolors#{Tty.reset} -> #{home}/Coding/dotfiles/lscolors"
